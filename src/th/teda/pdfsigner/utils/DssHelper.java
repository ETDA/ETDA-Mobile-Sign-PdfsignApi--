...
//            LDAPCertStoreParameters param = new LDAPCertStoreParameters();
//            LDAPCertStoreParameters xparam = LDAPCertStoreParameters.getInstance();
//            LDAPStoreHelper h = new LDAPStoreHelper(param); 
